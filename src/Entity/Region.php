...
class Region
{
    ...
    #[ORM\GeneratedValue]
    #[ORM\Column]
    #[Groups(["region.details", "region.list", "division.details", "subdivision.details", "structure:detail", "structure.list"])]
    private ?int $id = null;
    ...
    #[Groups(["region.details", "region.list"])]
    #[Context(
    ...
    #[ORM\OneToMany(mappedBy: 'region', targetEntity: Division::class, orphanRemoval: true)]
