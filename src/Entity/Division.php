...
class Division
{
    ...
    #[ORM\GeneratedValue]
    #[ORM\Column]
    #[Groups(["division.details", "division.list", "subdivision.details", "structure:detail", "structure.list"])]
    private ?int $id = null;
    ...
    #[Groups(["division.details", "subdivision.details", "structure:detail", "structure.list"])]
    private ?Region $region = null;

    #[ORM\Column(type: Types::DATETIME_MUTABLE)]
    #[Groups(["division.details", "division.list"])]
    #[Context(
    ...
    #[ORM\OneToMany(mappedBy: 'division', targetEntity: SubDivision::class, orphanRemoval: true)]
