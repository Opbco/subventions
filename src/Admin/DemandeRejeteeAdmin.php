...
final class DemandeRejeteeAdmin extends AbstractAdmin
{
    private $ts;

    protected $classnameLabel = 'Demandes rejetées - ';
    ...
    public function toString(object $object): string
    {
        return $object instanceof Demande
            ? $object->__toString()
            : 'Demande rejetee'; // shown in the breadcrumb on the create view
    }
    ...
    protected function configureListFields(ListMapper $list): void
    {
        $list
            ...
            $list->add('user_updated', null, ['label' => 'Validée par'])
    ...
    protected function configureRoutes(RouteCollectionInterface $collection): void
    {
        ...
        $collection->clearExcept(['list', 'show', 'export', 'edit']);
    }
